...
if (config.databaseUrl) {
  ...
  if (runningPid) {
    ...
    embeddedPostgres = new EmbeddedPostgres({
      ...
      // Override the hardcoded en_US.UTF-8 locale with C, which is available on
      // all systems including WSL environments that lack en_US.UTF-8 installed.
      // initdb accepts the last --lc-messages flag, so this overrides the library default.
